...
int main()
{
	...
	//***********load net prototxt ********************************
	const string proto("E:/VGG/imagenet-vgg-m-2048.prototxt");
	const string model("E:/VGG/VGG_CNN_M_2048.caffemodel");
	const string mean_file("E:/VGG/VGG_mean.binaryproto");
	const std::string mean_yml("E:/VGG/mean.yml");
	...
	capture.open("e:/data/crossing.avi");
	if (!capture.isOpened())
	{
